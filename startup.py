...
from makedata import make_website_info, \
    update_website_info, \
    read_proxy_info, \
    make_website_info_contract, \
    test_db, make_website_items_mapping, \
    make_website_info_sourcing_plan, \
    make_website_info_accept
...
# make_website_info_sourcing_plan()
# make_website_info_accept()
# make_website_items_mapping(website_id=11)
# reget_proxy()